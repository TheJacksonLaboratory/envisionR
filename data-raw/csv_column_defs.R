csv_column_defs <- list(version_numbers = c("v0.0.0.9000", "vTEST"),
                        demographics = list("v0.0.0.9000" = list(Group = readr::col_character(),
                        ...
                        cage_activity = list("v0.0.0.9000" = list(start = readr::col_datetime(format = ""),
                        ...
                        animal_activity = list("v0.0.0.9000" = list(start = readr::col_datetime(format = ""),
                                                                    start.date.local = readr::col_date(format = ""),
                                                                    start.time.local = readr::col_time(format = ""),
                                                                    study.code = readr::col_character(),
                                                                    aggregation.seconds = readr::col_double(),
