...
lightdark_times <- function(lights_on_time, lights_off_time,
  ...
  lights_on_hr_decimal = as.numeric(gsub("^(\\d{1,2}):(\\d{1,2})$",
                                         "\\1", lights_on_time))
  lights_on_mn_decimal = as.numeric(gsub("^(\\d{1,2}):(\\d{1,2})$",
                                         "\\2", lights_on_time))
  lights_off_hr_decimal = as.numeric(gsub("^(\\d{1,2}):(\\d{1,2})$",
                                          "\\1", lights_off_time))
  lights_off_mn_decimal = as.numeric(gsub("^(\\d{1,2}):(\\d{1,2})$",
                                          "\\2", lights_off_time))
  ...
  if (lights_on_decimal < lights_off_decimal) {
    lights_on_dates <- seq(from = as.Date(start_date),
