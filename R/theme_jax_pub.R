...
theme_jax_pub <- function(base_size = 11,
  ...
  stoifnot(requireNamespace("ggplot2"))
  ...
  t <- ggplot2::theme_grey(base_size = base_size,
    ...
    ggplot2::theme(text = ggplot2::element_text(family = "D-DIN", color = "#000100"), # All text is #000100 to allow editing
                   ...
                   axis.text = ggplot2::element_text(family = "D-DIN Expanded", size = base_size / 1.375),
                   axis.title = ggplot2::element_text(family = "D-DIN Expanded", size = base_size),
                   title = ggplot2::element_text(family = "D-DIN Expanded", size = 12 * base_size / 11),
                   complete = TRUE
    )
  return(t)
}
